                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <label id="tgl_diketahui" class="form-control" style="display: block;">{{ $data->tgl_pengajuan ? \Carbon\Carbon::parse($data->tgl_pengajuan)->format('d-m-Y') : ($data->updated_at ? \Carbon\Carbon::parse($data->updated_at)->format('d-m-Y') : \Carbon\Carbon::parse($data->created_at)->format('d-m-Y')) }}</label>
                                    <br><br>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <label class="form-label"><strong>Tgl:</strong></label>
                                    <label id="tgl_dievaluasi" class="form-control" style="display: block;">{{ $data->tgl_pengajuan ? \Carbon\Carbon::parse($data->tgl_pengajuan)->format('d-m-Y') : ($data->updated_at ? \Carbon\Carbon::parse($data->updated_at)->format('d-m-Y') : \Carbon\Carbon::parse($data->created_at)->format('d-m-Y')) }}</label>
                                    <br><br>
