                                    ...
                                    <div class="col-lg-6 border-start-lg">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <div class="form-floating flex-grow-1">
                                                        <input type="date" class="form-control" id="due_date_plan_${item.id}" name="due_date_plan[]" value="${item.due_date_plan || ''}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4 mb-lg-0">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <input type="date" class="form-control" name="due_date[]" id="due_date_${tempId}" required>
                                                <label>Due Date</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <div class="col-lg-6 border-start-lg">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <div class="form-floating flex-grow-1">
                                                    <input type="date" class="form-control" id="due_date_plan_${tempId}" name="due_date_plan[]">
                                                    <label>Date Aktual</label>
                                                </div>
