                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 h-100">
                        <div class="card-body p-3">
                            <h6 class="text-muted mb-2 small fw-bold text-uppercase">Status Pengajuan</h6>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge bg-secondary rounded-pill px-2">Draft: {{ $kpiStatusDraft ?? 0 }}</span>
                                <span class="badge bg-warning rounded-pill px-2 text-dark">Proses: {{ $kpiStatusProses ?? 0 }}</span>
                                <span class="badge bg-success rounded-pill px-2">Disetujui: {{ $kpiStatusSelesai ?? 0 }}</span>
                            </div>
                        </div>
                    </div>
                </div>
