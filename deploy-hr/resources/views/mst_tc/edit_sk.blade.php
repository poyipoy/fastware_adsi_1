    ...
    <main id="main" class="main">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group" style="margin-top: 2%">
                                ...
                                <select name="sk[id_job_position]" id="job_position_sk" class="form-control">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-4 form-floating mb-2">
                                                    <input type="text" name="sk[keterangan_sk][]"
                                                        id="keterangan_sk_{{ $data->id }}" class="form-control bg-light"
                                                        value="{{ $data->keterangan_sk }}" placeholder="Soft Skills">
                                                    <label for="keterangan_sk_{{ $data->id }}">Soft Skills</label>
                                                </div>
                                                <div class="col-md-4 form-floating mb-2">
                                                    <select name="sk[id_poin_kategori][]"
                                                        id="id_poin_kategori_sk_{{ $data->id }}" class="form-select bg-light">
                                                        <option value="">---- Pilih Kategori Nilai ----</option>
                                                        <option value="1" {{ $data->id_poin_kategori == 1 ? 'selected' : '' }}>Core Values</option>
                                                        <option value="2" {{ $data->id_poin_kategori == 2 ? 'selected' : '' }}>Leadership</option>
                                                    </select>
        ...
        <script>
            document.getElementById('combinedForm').addEventListener('submit', function(event) {
                ...
                const jobPositionId = formData.get('sk[id_job_position]');
                const data = {
                    'sk': {
                        'id_job_position': jobPositionId,
                        'keterangan_sk': [],
                        'id_poin_kategori': [],
                        'nilai': []
                    },
                ...
                document.querySelectorAll('[name="sk[id_poin_kategori][]"]').forEach(input => {
                    if (input.value === '') emptyFields = true;
                    data.sk.id_poin_kategori.push(input.value);
                });

                // Gather all input for nilai
                document.querySelectorAll('[name="sk[nilai][]"]').forEach(input => {
                    if (input.value === '') emptyFields = true;
                    data.sk.nilai.push(input.value);
                });
            ...
            function addField() {
                ...
                newFieldGroup.innerHTML = `
                    <div class="col-md-11">
                        <div class="row g-2">
                            <div class="col-md-4 form-floating mb-2">
                                <input type="text" name="sk[keterangan_sk][]" class="form-control bg-light" placeholder="Soft Skills">
                                <label>Soft Skills</label>
                            </div>
                            <div class="col-md-4 form-floating mb-2">
                                <select name="sk[id_poin_kategori][]" class="form-select bg-light">
                            ...
                            <div class="col-md-4 form-floating mb-2">
                                <select name="sk[nilai][]" class="form-select bg-light">
                                    <option value="">-- Nilai --</option>
