                ...
                <div class="warehouse-transaction-body">
                    ...
                    <section class="warehouse-flow-step" data-warehouse-step="2" aria-labelledby="warehouse-step-two-title" hidden>
                        ...
                        <div class="warehouse-detail-grid warehouse-transaction-fields">
                            ...
                            <div class="warehouse-form-field" data-warehouse-in-location><label class="form-label warehouse-required" for="warehouse-storage-location">Lokasi tujuan</label><select class="form-select" id="warehouse-storage-location" name="storage_location" data-warehouse-storage-location>@foreach(config('warehouse.storage_locations') as $location)<option value="{{ $location }}" @selected(old('storage_location', 'DS8') === $location)>{{ $location }}</option>@endforeach</select></div>
                            <div class="warehouse-form-field" data-warehouse-out-location><label class="form-label warehouse-required" for="warehouse-source-location">Lokasi asal</label><select class="form-select" id="warehouse-source-location" name="source_location" data-warehouse-source-location>@foreach(config('warehouse.storage_locations') as $location)<option value="{{ $location }}" @selected(old('source_location', 'DS8') === $location)>{{ $location }}</option>@endforeach</select></div>
                        </div>
