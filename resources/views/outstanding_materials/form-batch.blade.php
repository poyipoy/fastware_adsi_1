            ...
            <div class="card om-batch-card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3"><label for="batch_port" class="form-label">Port</label><select id="batch_port" name="port" class="form-select"><option value="">Pilih Port</option>@foreach (\App\Models\OutstandingMaterial::portOptions() as $port)<option value="{{ $port }}" @selected(old('port', $invoiceDefaults['port'] ?? '') === $port)>{{ $port }}</option>@endforeach</select></div>
                        <div class="col-md-3"><label for="batch_number_po" class="form-label">Nomor PO</label><input id="batch_number_po" name="number_po" class="form-control" value="{{ old('number_po', $invoiceDefaults['number_po'] ?? '') }}"></div>
                        ...
                        <div class="col-md-6"><label for="batch_remarks" class="form-label">Remarks</label><input id="batch_remarks" name="remarks" class="form-control" value="{{ old('remarks', $invoiceDefaults['remarks'] ?? '') }}"></div>
                    </div>
