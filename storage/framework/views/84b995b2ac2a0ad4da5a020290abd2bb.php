    ...
    <main id="main" class="main">
        <section class="section dashboard">
            ...
            <div class="card mt-3">
                ...
                <div style="margin-top: 3%">
                    <button onclick="window.location.href='<?php echo e(route('dsCompetency')); ?>'"
                                ...
                                <div class="col-md-4">
                                    <div class="card card-equal-height mb-3">
                                        <div class="card-header bg-primary text-white">
                                            <?php echo e($dataTc1->judul_keterangan); ?>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                <tbody>
                                                    <tr>
                                                        <td>1.</td>
                                                        <td><?php echo e($dataTc1->deskripsi_1); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2.</td>
                                                        <td><?php echo e($dataTc1->deskripsi_2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>3.</td>
                                                        <td><?php echo e($dataTc1->deskripsi_3); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>4.</td>
                                                        <td><?php echo e($dataTc1->deskripsi_4); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-equal-height mb-3">
                                        <div class="card-header bg-success text-white">
                                            <?php echo e($dataTc2->judul_keterangan); ?>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                <tbody>
                                                    <tr>
                                                        <td>1.</td>
                                                        <td><?php echo e($dataTc2->deskripsi_1); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2.</td>
                                                        <td><?php echo e($dataTc2->deskripsi_2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>3.</td>
                                                        <td><?php echo e($dataTc2->deskripsi_3); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>4.</td>
                                                        <td><?php echo e($dataTc2->deskripsi_4); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-equal-height mb-3">
                                        <div class="card-header" style="background-color: orange; color: white;">
                                            <?php echo e($dataTc3->judul_keterangan); ?>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                <tbody>
                                                    <tr>
                                                        <td>1.</td>
                                                        <td><?php echo e($dataTc3->deskripsi_1); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2.</td>
                                                        <td><?php echo e($dataTc3->deskripsi_2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>3.</td>
                                                        <td><?php echo e($dataTc3->deskripsi_3); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>4.</td>
                                                        <td><?php echo e($dataTc3->deskripsi_4); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
        ...
        <script>
            ...
            function fetchCompetencyData(userId) {
                fetch(`<?php echo e(route('get-detail-filter')); ?>?id_user=${userId}`)
            ...
            function loadCompetencyData(userId) {
                ...
                $(document).ready(function() {
                    $.ajax({
                        url: `<?php echo e(route('get-detail-filter')); ?>?id_user=${userId}`, // Gunakan id_user yang diambil dari URL
                        type: 'GET',
            ...
            function loadCompetencyDataViewOnly(userId) {
                $(document).ready(function() {
                    $.ajax({
                        url: `<?php echo e(route('get-detail-filter')); ?>?id_user=${userId}`,
                        type: 'GET',
                        success: function(data) {
            ...
            function loadTabelDataView(userId) {
                $(document).ready(function() {
                    ...
                    $.ajax({
                        url: `<?php echo e(route('get-detail-filter')); ?>?id_user=${userId}`, // Update with your route
                        method: 'GET',
            ...
            function downloadPdf(id) {
                var downloadPdfUrl = "<?php echo e(route('download.pdf', ['id' => ':id'])); ?>";
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fastware_adsi_1\resources\views/dashboard/dsDetailCompetency.blade.php ENDPATH**/ ?>