...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle blue-theme-header">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Menu List Penilaian Competency Div. Head</li>
                </ol>
            </nav>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (in_array($item->status, [3, 4]))
                                            <a href="{{ route('penilaian.edit3', $item->id_job_position) }}"
            ...
            function kirimData(id_job_position) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('update.status3', ':id_job_position') }}'.replace(':id_job_position',
                                id_job_position),
                            type: 'POST',
                            data: {
