...
@section('content')
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title font-sii">Ka.Dept / Ka.Sie - Persejutuan Inquiry</h5>
                    {{-- <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="{{ route('createinquiry') }}">Menu Inquiry Sales</a></li>
                    <li class="breadcrumb-item active">Persetujuan Ka.Dept</li>
                </ol>
            </nav> --}}
                </div>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <td>
                                                    <button
                                                        ...
                                                        {{ $inquiry->status == 8 ? 'btn-custom-approve-inventory' : '' }}">
                                                        {{ $statusDescriptions[$inquiry->status] ?? 'Tidak Diketahui' }}
                                                    </button>
                                                </td>
                                                <td>
                                                    @php
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @php
                                        ...
                                        // Filter inquiry berdasarkan region 2
        ...
        <script>
            ...
            jQuery(document).ready(function($) {
                const dataTable = new simpleDatatables.DataTable("#inquiryTableKaDept", {
