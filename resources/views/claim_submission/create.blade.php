            ...
            <div class="row">
                <div class="card">
                    <div class="card-header bg-secondary text-white">
                        <h5>Form Tambah Claim Submission</h5>
                    </div>

                    <div class="card-body" style="margin-top: 3%">
                        <form id="claimForm" action="{{ route('claim.store') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="no_pr" name="no_pr"
                                    placeholder="Masukkan No. PR" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category" name="category">
                                    ...
                                    <option value="Barang Salah Kirim (Item Mismatch)">Barang Salah Kirim (Item Mismatch)</option>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description_of_issue" name="description_of_issue" rows="4"
                                    placeholder="Jelaskan deskripsi masalah / ketidaksesuaian barang" required></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="proposed_solution" name="proposed_solution" rows="4"
                                    placeholder="Masukkan solusi yang diusulkan (opsional)"></textarea>
                            </div>
                            ...
                            <div class="mb-4 p-3 border rounded shadow-sm bg-light">
                                ...
                                <small class="text-muted">Format: gambar. Maksimal 10 MB.</small>
