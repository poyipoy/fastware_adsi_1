    ...
    <main id="main" class="main">
            ...
            <div class="card" style="width: 100%">
                ...
                <div class="dropdown-select">
                    ...
                    <select id="options" name="options" onchange="updateChart()">
                        ...
                        <?php $__currentLoopData = $jobPositions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobPosition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($jobPosition); ?>"><?php echo e($jobPosition); ?></option>
        ...
        <script>
            ...
            function updateChart() {
                ...
                if (jobPosition) {
                    $.ajax({
                        url: '<?php echo e(route('get-competency-data')); ?>',
                        type: 'GET',
                        data: {
            ...
            function updateChartData(index) {
                ...
                $.ajax({
                    url: '<?php echo e(route('get-competency-filter')); ?>',
                    type: 'GET',
                    data: {
            ...
            function btnDsDetail(userId) {
                ...
                window.location.href = `<?php echo e(route('dsDetailCompetency')); ?>?id_user=${userId}&id_job_position=${jobPosition}`;
            }
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fastware_adsi_1\resources\views/dashboard/dsCompetency.blade.php ENDPATH**/ ?>