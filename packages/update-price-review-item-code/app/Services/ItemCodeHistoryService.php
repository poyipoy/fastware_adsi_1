...
class ItemCodeHistoryService
{
    ...
    public const ACTION_PRICE_REVIEW_REQUESTED = 'price_review_requested';
    public const ACTION_PRICE_REVIEW_COMPLETED = 'price_review_completed';
    public const ACTION_PRICE_REVIEW_RETURNED = 'price_review_returned';
