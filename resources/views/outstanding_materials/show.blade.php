...
<style>
    ...
    .om-summary-row { display:grid; grid-template-columns:repeat(auto-fit,minmax(170px,1fr)); gap:12px; margin-bottom:1.25rem; }
    .om-summary-card { display:flex; align-items:center; gap:12px; background:#fff; border:1px solid #e5e7eb; border-left:4px solid #2563eb; border-radius:8px; padding:14px 16px; }
    ...
    .om-summary-icon { width:38px; height:38px; display:flex; align-items:center; justify-content:center; border-radius:7px; background:#eff6ff; color:#2563eb; }
    .om-summary-content { display:flex; flex-direction:column; } .om-summary-value { font-size:1.2rem; font-weight:700; line-height:1.2; } .om-summary-label { color:#6b7280; font-size:.72rem; text-transform:uppercase; letter-spacing:.04em; }
    ...
    .om-table thead th { position:sticky; top:0; z-index:3; background:#f9fafb; white-space:nowrap; text-align:center; vertical-align:middle; font-size:.74rem; padding:9px 10px; border-bottom:2px solid #e5e7eb; }
    .om-table thead tr:first-child th { z-index:4; background:#f9fafb; } .om-table tbody td { white-space:nowrap; vertical-align:middle; font-size:.82rem; padding:9px 10px; border-bottom:1px solid #f3f4f6; }
    .om-table tbody tr:nth-child(even) { background:#f9fafb; } .om-table tbody tr:hover { background:#eff6ff; }
    .om-filter-row th { position:sticky; top:var(--om-table-header-height,0px); z-index:3; background:#fff!important; padding:5px!important; }
    ...
    table.om-table.dataTable thead > tr.om-filter-row > th { position:sticky!important; top:var(--om-table-header-height,0px)!important; z-index:3!important; background:#fff!important; }
...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="om-summary-row">
            <div class="om-summary-card"><div class="om-summary-icon"><i class="bi bi-boxes"></i></div><div class="om-summary-content"><span class="om-summary-value">{{ number_format($summary['total']) }}</span><span class="om-summary-label">Total Material</span></div></div>
            ...
            <div class="om-summary-card"><div class="om-summary-icon"><i class="bi bi-speedometer2"></i></div><div class="om-summary-content"><span class="om-summary-value">{{ number_format($summary['est_qty_kg'], 2) }}</span><span class="om-summary-label">Estimated KG</span></div></div>
