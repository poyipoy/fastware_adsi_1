            ...
            <div class="card shadow-lg rounded">
                <div class="card-body">
                            ...
                            <tbody id="summaryBody">
                                ...
                                @foreach ($allCategories as $category)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="openModal({{ $actual ? $actual->id : 0 }})"><i class="bi bi-chat-square-text-fill"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="d-flex justify-content-center mt-3 gap-2">
                        ...
                        <button class="btn btn-secondary font-weight-bold px-4 text-white" onclick="resetInputs()">
                            Reset
                        </button>
                        <button class="btn btn-primary" onclick="saveData()">
                            Simpan
                        </button>
                        <button class="btn btn-danger" onclick="deletePermanen()">
                            Hapus
                        </button>
                    </div>
                </div>
            ...
            <div class="card shadow-lg">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center mt-3 gap-2">
                        ...
                        <button class="btn btn-info" onclick="deleteRows()">
                            Hapus Baris
                        </button>
                        <button class="btn btn-secondary text-white" onclick="resetInputs1()">
                            Reset
                        </button>
                        <button class="btn btn-primary" onclick="saveDetail()">
                            Simpan
                        </button>
                        <button class="btn btn-danger" onclick="hapusPermanenDetail()">
                            Hapus
                        </button>
                    </div>
                </div>
