...
@section('content')
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title font-sii">Ka. Sie - Persetujuan Inquiry Import</h5>
                    {{-- <nav>
                        <ol class="breadcrumb">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="btn btn-primary btn-sm"
                                                        onclick="approveKaSieImport({{ $inquiry->id }}); return false;">
                                                        <i class="bi bi-check-square-fill"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm"
                                                        onclick="rejectKaSieImport({{ $inquiry->id }}); return false;">
        ...
        <script>
            function approveKaSieImport(id) {
                $.ajax({
