                            ...
                            <form method="POST" action="{{ route('overviewPurchase.export') }}" id="overviewPurchaseExportForm">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-1" id="overviewTable">
                                        ...
                                        <tbody>
                                        @php $selectedInquiries = old('selected_inquiries', []); @endphp
                                        @foreach ($inquiries as $index => $inquiry)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input type="checkbox" name="selected_inquiries[]" value="{{ $inquiry->id }}" class="form-check-input inquiry-checkbox" {{ in_array($inquiry->id, $selectedInquiries) ? 'checked' : '' }}>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const updateSelectAllState = function () {
                    const checkboxes = Array.from(document.querySelectorAll('.inquiry-checkbox'));
                ...
                document.addEventListener('change', function (event) {
                    ...
                    if (event.target.classList && event.target.classList.contains('inquiry-checkbox')) {
