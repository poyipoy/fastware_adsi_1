...
@section('content')
    <main id="main" class="main">
        ...
        <section class="section">
            ...
            <div class="card">
                <form id="penilaianForm" action="{{ $updateRoute }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div class="d-flex gap-3">
                            <button type="button" onclick="window.location='{{ $backRoute }}'" class="btn btn-light border px-4 py-2 rounded-pill shadow-sm">
