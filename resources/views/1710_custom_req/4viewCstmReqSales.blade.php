            ...
            <div class="row">
                <section class="card-custom1 mb-4">
                    <div class="table-responsive">
                        ...
                        <button type="button" class="btn btn-sm btn-primary mb-2" onclick="window.history.back();">
                            Kembali
                        </button>

                        @if (in_array(auth()->user()->name, ['YULMAI RIDO WINANDA', 'ANDIK TOTOK SISWOYO', 'ADMINSTRATOR']))
                            @if ($materials->status_1 == 3 && !is_null($materials->harga_akhir) && $materials->harga_akhir !== '' && $materials->approval_1 == 'Waiting')
                                <!-- Tombol Approve -->
                                <button type="button" class="btn btn-sm btn-success btn-hover marketingButton mb-2"
                                ...
                                <!-- Tombol Reject -->
                                <button type="button" class="btn btn-sm btn-danger btn-hover rejectButton mb-2"
                                    data-id="{{ $materials->id }}"
                        ...
                        @if ($materials->status_1 == 4 )
                            <button type="button"
                                    class="btn btn-sm btn-success btn-hover productionButton mb-2"
                                    data-id="{{ $materials->id }}"
                            ...
                            {{-- Tombol Reject --}}
                            <button type="button" class="btn btn-sm btn-danger btn-hover rejectButton mb-2" data-id="{{ $materials->id }}"
                        ...
                        @if($materials->status_1 == 5)
                            <button
                                type="button" class="btn btn-warning btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#editNoSoModal" data-id="{{ $materials->id }}" data-noso="{{ $materials->so }}">
                                Edit No SO
                            </button>
                        @endif
                        @endif
                ...
                <section class="d-flex gap-4" style="height: 600px;">
                    ...
                    <article class="card-custom flex-fill d-flex flex-column">
                      ...
                      @if ($materials->status_1 == 2 && $materials->sec_line == 1)
