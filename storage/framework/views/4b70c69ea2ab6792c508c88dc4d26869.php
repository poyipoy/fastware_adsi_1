<?php $__env->startSection('content'); ?>
    <style>
        ...
        .carousel-scrollable .carousel-inner {
            display: flex;
            overflow-x: auto;
            -webkit-overflow-scrolling: touch;
        }
        .carousel-scrollable .carousel-inner::-webkit-scrollbar {
            height: 8px;
        }
        .carousel-scrollable .carousel-inner::-webkit-scrollbar-thumb {
            background: #ccc;
            border-radius: 4px;
        }
        .carousel-scrollable .carousel-item {
            flex: 0 0 100%;
            width: 100%;
        }
        .carousel-scrollable .carousel-control-prev,
        .carousel-scrollable .carousel-control-next,
        .carousel-scrollable .carousel-indicators {
            display: none;
        }
    </style>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="container-fluid dashboard-tcpd">
                ...
                ?>
                <div id="tcpdCarousel" class="carousel slide dashboard-carousel carousel-scrollable" data-bs-interval="false" data-bs-touch="true">
                                                ...
                                                <div class="d-flex flex-column gap-3">
                                                            ...
                                                            <div class="d-flex align-items-center gap-1">
                                                                ...
                                                                >
                                                                    ...
                                                                    <?php $__currentLoopData = $yearOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($year); ?>" <?php echo e((string) $year === (string) $companyYearFrom ? 'selected' : ''); ?>>
                                                                            <?php echo e($year); ?>
                                                                ...
                                                                >
                                                                    <option value="">All</option>
                                                                    <?php $__currentLoopData = $yearOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($year); ?>" <?php echo e((string) $year === (string) $companyYearTo ? 'selected' : ''); ?>>
                                                                            <?php echo e($year); ?>
                                                    ...
                                                    <div class="mt-1">
                                                        ...
                                                        <div
                                                            ...
                                                            data-empty-message="<?php echo e($companyEmptyMessage ?: 'Data persentase departemen belum tersedia.'); ?>"
                                                        >
                                                            <?php echo e($companyEmptyMessage ?: 'Data persentase departemen belum tersedia.'); ?>
                                        ...
                                        <div class="card dashboard-card level-4 h-100">
                                            <div class="card-body">
                                                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                                                    ...
                                                    <?php if($jobPositions->isNotEmpty()): ?>
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                >
                                                                    <?php $__currentLoopData = $jobPositions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($position->id); ?>" <?php echo e((int) $position->id === (int) $selectedJobPositionId ? 'selected' : ''); ?>>
                                                                            <?php echo e($position->job_position); ?>
                                                ...
                                                <div class="mt-3 position-relative">
                                                    ...
                                                    <div
                                                        ...
                                                        class="text-center text-muted small py-4 d-none"
                                                        data-empty-message="<?php echo e($chartEmptyMessage); ?>"
                                                    >
                                                        <?php echo e($chartEmptyMessage); ?>
                                                        ...
                                                        <tbody id="tcpd-competency-body">
                                                            <tr>
                                                                <td colspan="5" class="text-center text-muted small py-4">
                                                                    <?php echo e($selectedJobPositionName ? 'Memuat data...' : 'Silakan pilih job position untuk melihat data.'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const endpoints = <?php echo json_encode([
                'company' => route('dashboardTCPD.companyData'), 'job' => route('dashboardTCPD.data'), ]) ?>;
            ...
            let currentDepartmentData = <?php echo json_encode($departmentSummaries->values()->toArray(), 15, 512) ?>;
            ...
            initJobPositionChart(<?php echo json_encode($userSummaries, 15, 512) ?>);

            initCompanyChart(<?php echo json_encode($companyChartRows, 15, 512) ?>, <?php echo json_encode($companyOverview, 15, 512) ?>);
            ...
            function initCompanyChart(entries, summaryMeta = {}) {
                ...
                if (!normalized.length || !anyData) {
                    ...
                    instance.setOption({
                        title: {
                            text: emptyEl.dataset.emptyMessage || 'Data persentase departemen belum tersedia.',
                            left: 'center',
                            top: 'center',
                            textStyle: {
                                color: '#8c9aa5',
            ...
            function initJobPositionChart(entries) {
                ...
                if (!hasData) {
                    ...
                    instance.setOption({
                        title: {
                            text: emptyEl.dataset.emptyMessage || 'Data persentase belum tersedia.',
                            left: 'center',
                            top: 'center',
                            textStyle: {
                                color: '#8c9aa5',
            ...
            function initDepartmentCharts(departments) {
                ...
                departments.forEach((department, index) => {
                    ...
                    if (!availableEntries.length) {
                        ...
                        instance.setOption({
                            title: {
                                text: 'Data persentase belum tersedia untuk departemen ini.',
                                left: 'center',
                                top: 'center',
                                textStyle: {
                                    color: '#8c9aa5',
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fastware_adsi_1\resources\views/dashboard/dashboardTCPD.blade.php ENDPATH**/ ?>