            ...
            <form id="itemcode_form_new_product" method="POST" action="{{ route('item-code.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 itemcode-field-wrap {{ !empty($isSpecialRequester) ? 'd-none' : '' }}"
                            id="itemcode_new_price_standard_wrap">
                            <label for="itemcode_new_price_per_pcs" class="form-label">Price</label>
                            <input type="number" step="0.01" min="0" class="form-control fw-semibold"
                                id="itemcode_new_price_per_pcs" name="price_per_pcs"
                                {{ !empty($isSpecialRequester) ? 'disabled' : 'required' }}>
                        </div>

                        <div class="col-12 {{ !empty($isSpecialRequester) ? '' : 'd-none' }}"
                            id="itemcode_new_price_review_notice">
                            <div class="alert alert-warning mb-0" role="note">
                                <strong>Price tidak perlu diisi.</strong><br>
                                Harga akan diperiksa dan diisi oleh ILYAS NOOR FIRDAUS sebelum masuk ke proses approval.
                                <span class="d-block mt-1">
                                    Harga terakhir: <strong id="itemcode_new_reviewed_price_display">-</strong>
                                </span>
                            </div>
                        </div>
