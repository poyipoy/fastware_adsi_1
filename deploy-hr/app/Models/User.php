...
class User extends Authenticatable
{
    ...
    public function kmNotifications(): HasMany
    {
        return $this->hasMany(KmNotification::class, 'user_id');
    }

    public function kmPointLedgerEntries(): HasMany
    {
        return $this->hasMany(KmPointLedgerEntry::class, 'user_id');
    }

    public function kmInsightReactions(): HasMany
    {
        return $this->hasMany(KmInsightReaction::class, 'user_id');
    }
    ...
    public function participatedPeopleDevelopments()
    {
        return $this->belongsToMany(
            TcPeopleDevelopment::class,
