        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                if ($lastRow >= 6) {
                    ...
                    $sheet->getStyle("B6:G{$lastRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT);
                    $sheet->getStyle("H6:I{$lastRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                    ...
                    foreach ($this->mergeRanges as $range) {
                        ...
                        $sheet->getStyle("J{$startRow}:J{$endRow}")->getAlignment()
