...
class MstJobPosition extends Model
{
    ...
    /**
     * Scope: posisi yang merupakan Key Position.
     */
    ...
    /**
     * Relasi ke WorkingExperience (tidak langsung — via string job_position).
     * Digunakan untuk context referensial saja.
     */
    public function workingExperiences()
    {
        return $this->hasMany(\App\Models\WorkingExperience::class, 'job_position', 'position_name');
    }
}
