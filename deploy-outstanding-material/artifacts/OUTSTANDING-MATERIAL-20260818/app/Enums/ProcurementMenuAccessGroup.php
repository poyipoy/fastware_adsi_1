...
enum ProcurementMenuAccessGroup: string
{
    ...
    case ITEM_CODE_SPECIAL_REQUESTER = 'item_code_special_requester';
    case ITEM_CODE_PRICE_REVIEWER = 'item_code_price_reviewer';
    ...
    public function getAllowedUsers(): array
    {
        ...
        $itemCodeSpecialRequesterUsers = [
            'MAMIK ABIDIN',
        ];

        $itemCodePriceReviewerUsers = [
            'ILYAS NOOR FIRDAUS',
        ];
        ...
        return match($this) {
            ...
            self::ITEM_CODE_SPECIAL_REQUESTER => $itemCodeSpecialRequesterUsers,
            self::ITEM_CODE_PRICE_REVIEWER => $itemCodePriceReviewerUsers,
