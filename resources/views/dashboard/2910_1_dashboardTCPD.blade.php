            ...
            <div class="container-fluid dashboard-tcpd">
                ...
                <div class="mt-4">
                    <div class="department-section-header mb-3">
                        <div>
                            <h5 class="mb-1">Level 2 &mdash; Department Overview</h5>
                            <p class="text-muted mb-0 small">
                                Persentase rata-rata kompetensi untuk setiap job position dalam setiap departemen.
                            </p>
                        </div>
                        ...
                        <div class="card dashboard-card level-3 h-100">
                            <div class="card-body">
                                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                                    <div>
                                        <h5 class="card-title mb-2">Level 3 &mdash; Job Position Overview</h5>
                                        <p class="text-muted mb-0 small">
                ...
                <div class="row g-3 mt-3">
                    <div class="col-12">
                        <div class="card dashboard-card level-4 h-100">
                            <div class="card-body">
                                <div>
                                    <h5 class="card-title mb-2">Level 4 &mdash; Area Development</h5>
                                    <p class="text-muted mb-0 small">
