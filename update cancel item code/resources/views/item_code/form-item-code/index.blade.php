    ...
    <main id="main" class="main">
        @php
            ...
            $statsByType = $statsByType ?? [
                'new_product' => ['total' => 0, 'draft' => 0, 'submitted' => 0, 'approved_1' => 0, 'approved_2' => 0, 'finished' => 0, 'cancelled' => 0],
                'update_price' => ['total' => 0, 'draft' => 0, 'submitted' => 0, 'approved_1' => 0, 'approved_2' => 0, 'finished' => 0, 'cancelled' => 0],
            ];
            $statusClassMap = [
                'draft' => 'secondary',
            ...
            <div class="card itemcode-section-card">
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="{{ $activeTab === 'new_product' ? '' : 'd-none' }}">
                        @php
                            $newStats = $statsByType['new_product'] ?? ['total' => 0, 'draft' => 0, 'submitted' => 0, 'approved_1' => 0, 'approved_2' => 0, 'finished' => 0, 'cancelled' => 0];
                    ...
                    <div class="{{ $activeTab === 'update_price' ? '' : 'd-none' }}">
                        @php
                            $updateStats = $statsByType['update_price'] ?? ['total' => 0, 'draft' => 0, 'submitted' => 0, 'approved_1' => 0, 'approved_2' => 0, 'finished' => 0, 'cancelled' => 0];
